...
#line 434 "/NextBuildv8/Scripts/nextlib.bas"
	call _checkints
#line 3247 "/NextBuildv8/Scripts/nextlib.bas"

		ld iy,$5c3a
		jp endfilename

#line 3251 "/NextBuildv8/Scripts/nextlib.bas"
.LABEL._filename:
...
_WaitRetrace2__leave:
	ret
_InitMusic:
#line 22 "/NextBuildv8/Scripts/nextlib_ints.bas"
	...
	db $3e,$52,$01,$3b,$24,$ed,$79,$04,$ed,$78 : ld (exitplayerinit+3),a
#line 32

	db $3e,$56,$01,$3b,$24,$ed,$79,$04,$ed,$78 : ld (exitplayerinit+7),a
#line 33

	db $3e,$57,$01,$3b,$24,$ed,$79,$04,$ed,$78 : ld (exitplayerinit+11),a
#line 34
...
#line 97 "/NextBuildv8/Scripts/nextlib_ints.bas"
_InitMusic__leave:
	ret
_SetUpIM:
#line 97 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 132 "/NextBuildv8/Scripts/nextlib_ints.bas"
_SetUpIM__leave:
	ret
_ISR:
#line 145 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 153 "/NextBuildv8/Scripts/nextlib_ints.bas"
#line 164 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 177 "/NextBuildv8/Scripts/nextlib_ints.bas"
#line 179 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 193 "/NextBuildv8/Scripts/nextlib_ints.bas"
_ISR__leave:
	ret
_PlaySFX:
#line 198 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 283 "/NextBuildv8/Scripts/nextlib_ints.bas"
_PlaySFX__leave:
	ret
_InitSFX:
#line 283 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 356 "/NextBuildv8/Scripts/nextlib_ints.bas"
	call _CallbackSFX
	call _ISR
_InitSFX__leave:
	ret
_CallbackSFX:
#line 357 "/NextBuildv8/Scripts/nextlib_ints.bas"
...
#line 370
	...
	ld a,(ayfxbankinplaycode+1) : nextreg $51,a
	inc a : nextreg $52,a
...
#line 500 "/NextBuildv8/Scripts/nextlib_ints.bas"
_CallbackSFX__leave:
	ret
_NStr:
...
_NStr__leave:
	ret
_Init:
#line 30 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"

		nextreg SPRITE_CONTROL_NR_15,%00000001

#line 33 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
	ld a, 38
	call _InitSFX
	ld hl, 0
	push hl
	...
	xor a
	call _PlaySFX
#line 40 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
	: ld a,1 : ld (sfxenablednl+1),a :
#line 41 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
#line 41 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
	: ld a,1 : ld (sfxenablednl),a :
#line 42 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
_Init__leave:
	ret
_Main:
	xor a
	...
	call _InitSprites2
.LABEL.__LABEL2:
#line 53 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"

		nextreg TRANSPARENCY_FALLBACK_COL_NR_4A,255

#line 56 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
	call _ProcessMouse
	ld a, ((_Mouse) + (1))
	ld (_mox), a
	ld a, ((_Mouse) + (2))
	...
	push af
	call _L2Text
#line 64 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"

		nextreg TRANSPARENCY_FALLBACK_COL_NR_4A,0

#line 67 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
	ld a, 1
	call _WaitRetrace2
	ld a, (_mbutt)
	and 3
...
_Main__leave:
	ret
_ProcessMouse:
#line 101 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
...
#line 224 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
...
#line 240 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
...
__LOADSTR:		; __FASTCALL__ entry
	    ...
	    pop namespace
#line 241 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
...
#line 242 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
...
#line 243 "c:\\NextBuildv8\\Sources\\ModuleDemo\\Module1.bas"
