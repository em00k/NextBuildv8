...
#line 11 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
		nextreg TURBO_CONTROL_NR_07,%0
		nextreg GLOBAL_TRANSPARENCY_NR_14,$1
		...
		di
#line 26 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
	ld hl, 16384
	push hl
...
.LABEL.__LABEL9:
	...
	jp .LABEL.__LABEL5
.LABEL._fontzx7:
#line 169 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
		incbin ".\data\topan.fnt.zx7"
		defs 6,0
#line 172 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
.LABEL._palettezx7:
#line 175 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
		incbin ".\data\mm.pal.zx7"
		defs 6,0
#line 178 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
	ld bc, 0
.core.__END_PROGRAM:
	di
...
_checkints__leave:
	ret
_NextRegA:
#line 885 "/NextBuildv7/Scripts/nextlib.bas"
		PROC
		LOCAL reg
		ld (reg),a
		pop hl
...
reg:
		...
		push hl
		ENDP
#line 898 "/NextBuildv7/Scripts/nextlib.bas"
_NextRegA__leave:
	ret
_zx7Unpack:
	push ix
	ld ix, 0
	add ix, sp
#line 918 "/NextBuildv7/Scripts/nextlib.bas"
		LD E, (IX+6)
		LD D, (IX+7)
		call dzx7_turbo
		jp zx7end
...
dzx7s_next_bit:
		...
		ret
zx7end:
#line 990 "/NextBuildv7/Scripts/nextlib.bas"
_zx7Unpack__leave:
	ld sp, ix
	pop ix
	exx
	...
	ret
_WaitRetrace2:
#line 3015 "/NextBuildv7/Scripts/nextlib.bas"
		PROC
		LOCAL readline
	pop hl : exx
		ld d,0
...
readline:
	...
	exx : push hl
		ENDP
#line 3041 "/NextBuildv7/Scripts/nextlib.bas"
_WaitRetrace2__leave:
	ret
_TextBlock:
#line 65 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
		DB $c5,$DD,$01,$0,$0,$c1
#line 66
	exx : pop hl : exx
...
col:
	...
	exx : push hl : exx
		pop namespace
		ret
#line 108 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
_TextBlock__leave:
	ex af, af'
	exx
	ld l, (ix+8)
	...
	ret
_ClearTilemap:
#line 110 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
		ld hl,$4400
		ld de,$4401
		ld bc,2560*2
		ld (hl),0
		ldir
#line 116 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
...
__LOADSTR:		; __FASTCALL__ entry
	    ...
	    pop namespace
#line 173 "c:\NextBuildv7\Sources\Textmode\textmode.bas"
