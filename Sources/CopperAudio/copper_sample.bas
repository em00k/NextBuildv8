...
dim sample,pattern_position,play,sam,start as ubyte 
...
asm 
	...
	pat2: db 1,6,4,6,2,6,4,6,1,6,4,6,2,6,4,6,$ff 
	pat3: db 1,6,6,6,2,6,6,6,1,6,6,6,2,6,6,6,$ff 
