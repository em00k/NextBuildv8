...
LoadSDBank("/monster/output.dat",0,0,0,32)					'; Load sample into bank 32-33
...
asm 
    ...
    pat3:
        db 1,0,3,3, 2,0,3,3, 1,0,3,3, 2,0,3,3,$ff 
    pat4:
...
asm 
    ...
    dw $2001,0,2994 ; 1kick.raw
    dw $2001,2994,6692 ; 2snare.raw
    dw $2001,9686,2800 ; 3hhat.raw
	dw $2001,0,0
